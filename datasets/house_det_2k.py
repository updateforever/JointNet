...
from utils.data import cvtColor, preprocess_input
...
class CenternetDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        image = np.transpose(preprocess_input(image), (2, 0, 1))  # mean std
...
class house2k_det(Dataset):
    ...
    def __init__(self, root, image_set='train', transform=None, img_sz=None):
        ...
        self.root = os.path.expanduser(root)  # /root/autodl-tmp/house-2k/VOCdevkit
        ...
        self.labels = [os.path.join(mask_dir, x + ".txt") for x in file_names]
        # if img_sz is not None:
